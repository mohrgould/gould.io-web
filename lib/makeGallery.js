...
module.exports = function makeGallery (targetDir, sourceDir, config) {
  ...
  frontHTML += '</body>' +
    '<footer><a href="mailto:david@gould.io">david@gould.io</a></footer>' +
    '</html>';
...
function photoHTML (photoData, length, googleAnalyticsTrackingId) {
  var html = '<!doctype html>' +
    '<html lang="en">' +
    '<head>' +
    '<meta charset="utf-8">' +
    '<title>David Mohr Gould Photos - ' + photoData.title + '</title>' +
    '<link rel="stylesheet" href="/site.css">';
  ...
  html += '</head>' +
    '<body>' +
    '<h2><a href="/' + photoData.galleryName + '/">&#9664; David Mohr Gould</a></h2>' +
    '<nav>' +
...
function galleryHTML (galleryName, galleryTitle, photos, googleAnalyticsTrackingId) {
  ...
  html += '</head>' +
    '<body>' +
    '<h2><a href="/">David Mohr Gould ' + galleryName + '</a></h2>';
